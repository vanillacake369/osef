...
CREATE TABLE IF NOT EXISTS `equipment` (
  ...
  `close` tinyint(1) unsigned NOT NULL DEFAULT 0 COMMENT '종료 빌리면1 elvhfxm 0',
  PRIMARY KEY (`id`)
...
-- 테이블 performance_schema.replication_applier_status_by_worker 구조 내보내기
...
-- 프로시저 sys.create_synonym_db 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.execute_prepared_stmt 구조 내보내기
DELIMITER //
...
-- 함수 sys.extract_schema_from_file_name 구조 내보내기
DELIMITER //
...
-- 함수 sys.extract_table_from_file_name 구조 내보내기
DELIMITER //
...
-- 함수 sys.format_statement 구조 내보내기
DELIMITER //
...
-- 뷰 sys.host_summary_by_file_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.host_summary_by_file_io_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.host_summary_by_stages 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.host_summary_by_statement_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.host_summary_by_statement_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.innodb_buffer_stats_by_schema 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.innodb_buffer_stats_by_table 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.innodb_lock_waits 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.io_by_thread_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.io_global_by_file_by_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.io_global_by_file_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.io_global_by_wait_by_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.io_global_by_wait_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.memory_by_host_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.memory_by_thread_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.memory_by_user_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.memory_global_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.memory_global_total 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
CREATE TABLE `memory_global_total` (
	`total_allocated` TEXT NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- 뷰 sys.metrics 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.ps_check_lost_instrumentation 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 함수 sys.ps_is_account_enabled 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_is_consumer_enabled 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_is_instrument_default_enabled 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_is_instrument_default_timed 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_is_thread_instrumented 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_disable_background_threads 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_disable_consumer 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_disable_instrument 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_disable_thread 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_enable_background_threads 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_enable_consumer 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_enable_instrument 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_enable_thread 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_reload_saved 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_reset_to_default 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_save 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_disabled 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_disabled_consumers 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_disabled_instruments 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_enabled 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_enabled_consumers 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_setup_show_enabled_instruments 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_statement_avg_latency_histogram 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_thread_account 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_thread_stack 구조 내보내기
DELIMITER //
...
-- 함수 sys.ps_thread_trx_info 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_trace_statement_digest 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_trace_thread 구조 내보내기
DELIMITER //
...
-- 프로시저 sys.ps_truncate_all_tables 구조 내보내기
DELIMITER //
...
-- 함수 sys.quote_identifier 구조 내보내기
DELIMITER //
...
-- 뷰 sys.schema_auto_increment_columns 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_index_statistics 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_object_overview 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_redundant_indexes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_tables_with_full_table_scans 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_table_lock_waits 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_table_statistics 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_table_statistics_with_buffer 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.schema_unused_indexes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.session_ssl_status 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statements_with_errors_or_warnings 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statements_with_full_table_scans 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statements_with_runtimes_in_95th_percentile 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statements_with_sorting 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statements_with_temp_tables 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.statement_analysis 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 프로시저 sys.statement_performance_analyzer 구조 내보내기
DELIMITER //
...
-- 뷰 sys.user_summary_by_file_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.user_summary_by_file_io_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.user_summary_by_stages 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.user_summary_by_statement_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.user_summary_by_statement_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.waits_by_host_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.waits_by_user_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.waits_global_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.wait_classes_global_by_avg_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.wait_classes_global_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$host_summary_by_file_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$host_summary_by_file_io_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$host_summary_by_stages 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$host_summary_by_statement_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$host_summary_by_statement_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$innodb_buffer_stats_by_schema 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$innodb_buffer_stats_by_table 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$innodb_lock_waits 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$io_by_thread_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$io_global_by_file_by_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$io_global_by_file_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$io_global_by_wait_by_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$io_global_by_wait_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$latest_file_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$memory_by_host_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$memory_by_thread_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$memory_by_user_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$memory_global_by_current_bytes 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$ps_digest_95th_percentile_by_avg_us 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$ps_digest_avg_latency_distribution 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$ps_schema_table_statistics_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_flattened_keys 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_index_statistics 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_tables_with_full_table_scans 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_table_lock_waits 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_table_statistics 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$schema_table_statistics_with_buffer 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statements_with_errors_or_warnings 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statements_with_full_table_scans 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statements_with_runtimes_in_95th_percentile 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statements_with_sorting 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statements_with_temp_tables 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$statement_analysis 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$user_summary_by_file_io 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$user_summary_by_file_io_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$user_summary_by_stages 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$user_summary_by_statement_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$user_summary_by_statement_type 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$waits_by_host_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$waits_by_user_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$waits_global_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$wait_classes_global_by_avg_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
...
-- 뷰 sys.x$wait_classes_global_by_latency 구조 내보내기
-- VIEW 종속성 오류를 극복하기 위해 임시 테이블을 생성합니다.
